...
# Validar estructura de Repositorio
   if [[ -z $comment ]]; then #si comment esta vacia
      echo  '---------------------------------------------------------------------'
      echo "Ejemplo de Ejecucion"
      echo " sh pushGit.sh \"comentario\" \"rama\" \"clone\" "
      echo  '---------------------------------------------------------------------'
...
# Configuracion gobal del repositorio
   git config --global user.email "geraldinpinzonb@gmail.com"
   git config --global user.name "Geraldin Pinzon"
